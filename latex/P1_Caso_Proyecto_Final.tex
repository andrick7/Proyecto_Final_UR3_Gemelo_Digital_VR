...
\begin{enumerate}[leftmargin=1.2cm]
    ...
    encargada de Simulink, MoveIt 2, planeación de trayectorias,
...
Ejecutar Simulink, MoveIt 2, YOLO, planeación de movimiento y agente de IA. \\
...
Control del UR3 &
MQTT &
MQTT funciona muy bien para telemetría, pero no es la mejor opción para ejecutar trayectorias del robot. Se selecciona Simulink y RTDE. \\
...
Procesamiento principal &
Raspberry Pi &
Aunque puede ejecutar tareas básicas, Simulink, MoveIt, visión e IA simultáneamente requieren mayor capacidad de procesamiento. \\
